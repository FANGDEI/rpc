...
var file_proto_hello_proto_rawDesc = []byte{
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x49, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72,
	0x12, 0x3e, 0x0a, 0x09, 0x41, 0x6c, 0x6c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x14, 0x2e,
...
var file_proto_hello_proto_depIdxs = []int32{
	0, // 0: proto.Greeter.AllStream:input_type -> proto.StreamRequest
	1, // 1: proto.Greeter.AllStream:output_type -> proto.StreamResponse
...
func (c *greeterClient) AllStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_AllStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/proto.Greeter/AllStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greeterAllStreamClient) Send(m *StreamRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greeterAllStreamClient) Recv() (*StreamResponse, error) {
...
func (x *greeterAllStreamServer) Send(m *StreamResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greeterAllStreamServer) Recv() (*StreamRequest, error) {
	m := new(StreamRequest)
