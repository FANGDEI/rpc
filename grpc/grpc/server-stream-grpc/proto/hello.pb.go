...
var file_proto_hello_proto_rawDesc = []byte{
	...
	0x12, 0x3c, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x14, 0x2e,
	...
	0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x0a,
...
var file_proto_hello_proto_depIdxs = []int32{
	0, // 0: proto.Greeter.GetStream:input_type -> proto.StreamRequest
	1, // 1: proto.Greeter.GetStream:output_type -> proto.StreamResponse
...
type GreeterClient interface {
	GetStream(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (Greeter_GetStreamClient, error)
}
...
func (c *greeterClient) GetStream(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (Greeter_GetStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/proto.Greeter/GetStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greeterGetStreamClient) Recv() (*StreamResponse, error) {
...
type GreeterServer interface {
	GetStream(*StreamRequest, Greeter_GetStreamServer) error
}
...
func (*UnimplementedGreeterServer) GetStream(*StreamRequest, Greeter_GetStreamServer) error {
...
func (x *greeterGetStreamServer) Send(m *StreamResponse) error {
